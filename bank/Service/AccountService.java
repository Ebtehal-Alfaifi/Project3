...
public class AccountService {
    ...
    public List<Account> getAllAccounts(Integer authId) {
        ...
        if (auth == null) {
            throw new ApiException("Admin or Employee was not found");
        }
    ...
    public void transferAmount(Integer customerId, Integer senderAccountId, Integer receiverAccountId, Double amount) {
        ...
        if (!sender.getIsActive()){
            throw new ApiException("The sender account is not activated ");
        }

        if (!receiver.getIsActive()){
            throw new ApiException("The receiver account is not activated ");
        }

        if (sender.getBalance()<amount) {
            throw new ApiException("You don't have enough balance to transfer this amount");}
